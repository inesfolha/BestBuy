...
def main():
    ...
    print(product_list[0].set_promotion(second_half_price))
    print(product_list[1].set_promotion(third_one_free))
    print(product_list[3].set_promotion(thirty_percent))

    print(product_list[0].promotion)
    print(product_list[1].promotion)
    print(product_list[3].promotion)
